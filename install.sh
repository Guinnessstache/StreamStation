...
REPO_URL="https://github.com/YOUR_USERNAME/StreamStation.git"
...
# Note: tm1637 PyPI package is NOT installed — StreamStation uses its own
# bundled driver (hardware/tm1637_driver.py) which supports Raspberry Pi 5.
